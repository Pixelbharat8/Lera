    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b">
            <Link to="/teacher" className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold bg-gradient-to-r from-emerald-500 to-teal-600 bg-clip-text text-transparent">Teacher Portal</span>
            </Link>
            <button
              className="lg:hidden"
      ...
      <div className="flex-1 min-w-0 flex flex-col lg:ml-64">
        ...
        <div className="lg:hidden flex items-center h-16 bg-white border-b px-4">
          ...
          <span className="ml-4 text-lg font-medium">Teacher Portal</span>
        </div>
