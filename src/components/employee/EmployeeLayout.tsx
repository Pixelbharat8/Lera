...
const EmployeeLayout = ({ children }: { children: React.ReactNode }) => {
  ...
  const navigation = [
    ...
    { name: 'AI Assistant', path: '/employee/ai', icon: Bot },
  ];
    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b">
            <Link to="/employee" className="flex items-center">
              ...
              <span className="ml-3 text-xl font-bold bg-gradient-to-r from-orange-500 to-red-600 bg-clip-text text-transparent">Employee Portal</span>
            </Link>
            <button
              className="lg:hidden"
      ...
      <div className="flex-1 min-w-0 flex flex-col lg:ml-64">
        ...
        <div className="lg:hidden flex items-center h-16 bg-white border-b px-4">
          ...
          <span className="ml-4 text-lg font-medium">Employee Portal</span>
        </div>
